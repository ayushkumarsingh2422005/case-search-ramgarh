      ...
      <div className="mx-auto max-w-7xl p-4 md:p-6">
        ...
        <div className="bg-white rounded-lg shadow-sm ring-1 ring-slate-200 overflow-hidden mb-6">
          <div className="px-4 py-4 md:px-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    setSearchFilters({ ...searchFilters, investigatingOfficer: e.target.value as typeof searchFilters.investigatingOfficer });
                    setPage(1);
                  }}
                  className="w-full px-3 py-2 rounded-lg border border-slate-300 bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-shadow"
                >
            ...
            {(searchFilters.caseNo || searchFilters.year || searchFilters.policeStation || searchFilters.investigatingOfficer) && (
                ...
                <table className="min-w-full divide-y divide-slate-200">
                  <thead className="bg-slate-50">
                    <tr>
                      ...
                      <th className="px-4 py-3 text-left text-xs font-medium text-slate-700 uppercase tracking-wider">I.O.</th>
                  ...
                  <tbody className="bg-white divide-y divide-slate-200">
                    {cases.map((caseItem) => (
                      <tr key={caseItem._id} className="hover:bg-slate-50">
                        ...
                        <td className="px-4 py-3 whitespace-nowrap text-sm text-slate-600">{caseItem.investigatingOfficer || "—"}</td>
