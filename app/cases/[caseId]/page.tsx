  ...
  const summary = useMemo(() => {
    if (!caseData) {
      return {
        ...
        policeStation: "",
        crimeHead: "",
        investigatingOfficer: undefined as string | undefined,
        section: "",
    ...
    return {
      ...
      investigatingOfficer: caseData.investigatingOfficer || undefined,
          ...
          <div className="px-4 py-4 md:px-6 md:py-5 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex-1">
              ...
              <p className="text-sm text-slate-600">
                {summary.policeStation} • {summary.section} • {summary.crimeHead}
                {summary.investigatingOfficer ? ` • I.O.: ${summary.investigatingOfficer}` : ""}
              </p>
            </div>
            <div className="flex items-center gap-2 flex-wrap">
              {user?.role === "SuperAdmin" && (
                <Link
                  href={`/edit/${caseId}`}
                  title="Edit Case"
                  className="inline-flex items-center justify-center rounded-md bg-blue-600 p-2 text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-colors"
                >
              ...
              <button
                ...
                title="Print PDF"
                className="inline-flex items-center justify-center rounded-md bg-green-600 p-2 text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 transition-colors"
              >
                <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card title="Case Summary">
                  <ul className="text-sm space-y-2">
                    ...
                    {summary.investigatingOfficer ? (
                      <li><strong className="font-medium">Investigating Officer:</strong> {summary.investigatingOfficer}</li>
                    ) : (
                      <li><strong className="font-medium">Investigating Officer:</strong> <span className="text-slate-500">Not assigned</span></li>
                    )}
